		...
		menu:EditPage("Main", function(x)
			...
			x:EditPage("Info", function(y)
				...
				y:AddSideButton("TGNS Forums", function()
					TGNS.ShowUrl("https://www.tacticalgamer.com/action/natural-selection/natural-selection-general-discussion/", "TGNS Forums")
				end)
			...
			x:AddSideButton("Supporting Memberships", function()
				TGNS.ShowUrl("http://www.tacticalgamer.com/natural-selection-general-discussion/63720-help-fellow-player.html", "TG Supporting Memberships")
			end)
