		...
		menu:EditPage("Main", function(x)
			...
			x:EditPage("Info", function(y)
				...
				y:AddSideButton("TGNS Rules", function()
					TGNS.ShowUrl("http://www.tacticalgamer.com/natural-selection-official-rules-and-announcements/190764-rules-server-print.html", "TGNS Rules (also: see TGNS Primer and forum's Required Reading)")
				end)
				y:AddSideButton("TGNS Forums", function()
					TGNS.ShowUrl("http://www.tacticalgamer.com/action/natural-selection/", "http://www.tacticalgamer.com/action/natural-selection/")
				end)
				y:AddSideButton("Contact an Admin", function()
					TGNS.ShowUrl("http://www.tacticalgamer.com/natural-selection-general-discussion/106028-contact-ns-admin-print.html", "Contact an Admin")
				end)
				...
				y:AddSideButton("sh_specmode", function()
					TGNS.ShowUrl("http://www.tacticalgamer.com/natural-selection-general-discussion/195215-sh_specmode-print.html", "sh_specmode")
				end)
				y:AddSideButton("sh_fullspec", function()
					TGNS.ShowUrl("http://www.tacticalgamer.com/natural-selection-general-discussion/195242-sh_fullspec-print.html")
				end)
			end)
