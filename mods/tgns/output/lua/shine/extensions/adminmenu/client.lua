		...
		menu:EditPage("Main", function(x)
			...
			x:EditPage("Info", function(y)
				...
				y:AddSideButton("TGNS Forums", function()
					TGNS.ShowUrl("https://docs.google.com/document/d/1tZ0ZcqnMnfklz6QPp5QwLqPuJDxaxp8U5IIh7HDN19k/edit#heading=h.ewixe41v4vib", "TGNS Forums")
				end)
			...
			x:AddSideButton("Feedback", function()
				TGNS.ShowUrl("http://rr.tacticalgamer.com/FeedbackServer", "TGNS Portal - http://rr.tacticalgamer.com")
			end)
