...
Plugin.MAIN_BUTTONS_REQUESTED = "adminMenu_MAIN_BUTTONS_REQUESTED"
...
TGNS.RegisterNetworkMessage(Plugin.MAIN_BUTTONS_REQUESTED, {buttonText="string(30)", pageName="string(30)"})
